...
import type { WebhookEventResourceRelationshipsTransactionLinks } from './webhookEventResourceRelationshipsTransactionLinks';

export type WebhookEventResourceRelationshipsTransaction = {
