 ...
 */
import type { TransactionResourceRelationshipsParentCategoryData } from './transactionResourceRelationshipsParentCategoryData';
import type { TransactionResourceRelationshipsParentCategoryLinks } from './transactionResourceRelationshipsParentCategoryLinks';

export type TransactionResourceRelationshipsParentCategory = {
  /** @nullable */
