 ...
 */
import type { TransactionResourceRelationshipsCategoryData } from './transactionResourceRelationshipsCategoryData';
import type { TransactionResourceRelationshipsCategoryLinks } from './transactionResourceRelationshipsCategoryLinks';

export type TransactionResourceRelationshipsCategory = {
  /** @nullable */
