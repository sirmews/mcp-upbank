...
import type { TransactionResourceRelationshipsAccountLinks } from './transactionResourceRelationshipsAccountLinks';

export type TransactionResourceRelationshipsAccount = {
